...
function dsi_get_post_types_grouped($type = "", $tag = false){
	...
	if($type === "school")
		...
		$post_types = array("evento", "post","circolare", "documento", "luogo", "scheda_didattica", "scheda_progetto", "servizio", "indirizzo", "struttura", "page", "amm-trasparente");
...
// INIZIO MODIFICA EASYTEM
// CORREGGE IL PROBLEMA DELLA VERIFICA AGID
            if ($url) {
